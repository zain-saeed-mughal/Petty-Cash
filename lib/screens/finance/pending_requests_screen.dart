            ...
            Wrap(
              ...
              children: [
                if (req.billImageUrl != null)
                  Row(
                    children: const [
                      Icon(Icons.attachment_rounded, size: 16, color: AppTheme.primaryBlue),
                      SizedBox(width: 4),
                      Text('Receipt attached', style: TextStyle(fontSize: 12, color: AppTheme.primaryBlue, fontWeight: FontWeight.w600)),
                    ],
                  )
                else
                  const Text('No bill image', style: TextStyle(fontSize: 12, color: Color(0xFF94A3B8))),
                ElevatedButton.icon(
