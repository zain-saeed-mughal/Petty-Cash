...
class _ReceiptImageState extends State<ReceiptImage> {
  ...
  @override
  void didUpdateWidget(ReceiptImage old) {
    super.didUpdateWidget(old);
    if (old.imageUrl != widget.imageUrl) _resolve();
  }

  void _resolve() {
    _url = StorageService().resolveReceipt(widget.imageUrl);
  }

  Widget _error(Object e) =>
      widget.errorWidget?.call(context, widget.imageUrl, e) ??
      Center(
        child: Column(
          ...
          children: [
            ...
            Text(context.t('Receipt unavailable'), textAlign: TextAlign.center),
            TextButton(
